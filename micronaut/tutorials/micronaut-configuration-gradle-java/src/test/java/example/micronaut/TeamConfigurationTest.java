...
public class TeamConfigurationTest {
    ...
    void testTeamConfiguration() {
        ...
        ApplicationContext ctx = ApplicationContext.run(items); // <1> set up configuration for the test
        TeamConfiguration teamConfiguration = ctx.getBean(TeamConfiguration.class); //get bean
